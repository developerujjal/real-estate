        ...
        <div
            ...
            <div className="p-4 border-t mx-8 mt-2">
                <button
                    ...
                    className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Edit Profile</button>

            </div>

            {
                isModalOpen === true && <EditModal handleCloseModal={handleCloseModal} isModalOpen={isModalOpen} />
            }
        </div>
    );
};
