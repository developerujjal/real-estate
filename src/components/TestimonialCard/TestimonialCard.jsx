        ...
        <div
            ...
            <div className="md:flex">
                <div className="md:shrink-0">
                    <img className="h-48 w-full object-cover md:h-full md:w-48" src="https://randomuser.me/api/portraits/women/91.jpg" alt="User profile picture" />
                </div>
                <div className="p-8">
                    ...
                    <div className="mt-4">
                        ...
                        <span className="text-slate-600 text-sm ml-2">{customer_type}</span>
                    </div>
