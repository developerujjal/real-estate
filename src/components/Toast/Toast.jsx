...
const Toast = () => {
    return (
        <div className="bg-green-500 text-white font-semibold tracking-wide flex items-center w-max max-w-sm p-4 rounded-md shadow-md shadow-green-200" role="alert">
            ...
            <span className="block sm:inline text-sm mr-3">Update successfully</span>
